...
public interface IStockRepo extends CrudRepository<Stock, Long> {
    ...
    List<Stock> findByStockTypeAndStockPriceLessThanEqualOrderByStockPriceDesc(Type stockType, double stockPrice);

    List<Stock> findByStockPriceLessThanAndStockCreationTimeStampLessThanOrderByStockOwnerCountDesc(double stockPrice, LocalDateTime time);
